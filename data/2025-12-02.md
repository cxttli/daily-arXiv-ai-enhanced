...
### [1] [Fluid Antenna System-Enabled UAV Communications in the Finite Blocklength Regime](https://arxiv.org/abs/2511.21834)
...
### [2] [Spectrum-Aware IRS Configuration Techniques for Ultrawideband Signals](https://arxiv.org/abs/2511.21927)
...
### [3] [Four classes of optimal p-ary cyclic codes](https://arxiv.org/abs/2511.22086)
...
### [4] [Fluid Antenna-Enhanced Flexible Beamforming](https://arxiv.org/abs/2511.22163)
...
### [5] [Constructions of block MDS LDPC codes from punctured circulant matrices](https://arxiv.org/abs/2511.22183)
...
### [6] [Maximum Entropy and Bayesian Conditioning Under Extended Space](https://arxiv.org/abs/2511.22375)
*Boning Yu*
...
### [7] [On the SER Performance of ZF and MMSE Receivers in Pilot-Aided Simultaneous Communication and Localization](https://arxiv.org/abs/2511.22418)
...
### [8] [TransCoder: A Neural-Enhancement Framework for Channel Codes](https://arxiv.org/abs/2511.22539)
...
### [9] [Maximum Spectral Efficiency With Adaptive MQAM Transmissions Over Terrestrial Coherent FSO Links](https://arxiv.org/abs/2511.22682)
...
### [10] [On Information Theoretic Fairness With A Bounded Point-Wise Statistical Parity Constraint: An Information Geometric Approach](https://arxiv.org/abs/2511.22683)
...
### [11] [Leveraging Channel Knowledge Map for Multi-User Hierarchical Beam Training Under Position Uncertainty](https://arxiv.org/abs/2511.22902)
...
### [12] [Decoding Trombetti-Zhou codes: a new syndrome-based decoding approach](https://arxiv.org/abs/2511.23202)
...
### [13] [Efficient Estimation of Sum-Parameters for Multi-Component Complex Exponential Signals with Theoretical Cramer-Rao Bound Analysis](https://arxiv.org/abs/2511.23318)
*Huiguang Zhang*
...
### [14] [Quantum Private Distributed Matrix Multiplication With Degree Tables](https://arxiv.org/abs/2511.23406)
...
### [15] [Internodal Distance Distributions for Static and Mobile Nodes in 2D/3D Wireless Networks](https://arxiv.org/abs/2511.21864)
...
### [16] [Joint Estimation of Sea State and Vessel Parameters Using a Mass-Spring-Damper Equivalence Model](https://arxiv.org/abs/2511.21997)
...
### [17] [CUNEC: A Path Loss Model for Urban Cell-Free Massive MIMO Networks](https://arxiv.org/abs/2511.22041)
...
### [18] [Bistatic Passive Tracking via CSI Power](https://arxiv.org/abs/2511.22144)
...
### [19] [A Model and Data Dual-driven Approach for Multitargets Detection under Mainlobe Jamming](https://arxiv.org/abs/2511.22201)
...
### [20] [Foundation Model for Intelligent Wireless Communications](https://arxiv.org/abs/2511.22222)
...
### [21] [Pinching-Antenna Systems-Assisted SWIPT: A Rate-Energy Trade-off Perspective](https://arxiv.org/abs/2511.22224)
...
### [22] [NOMA Assisted Downlink Power Allocation in Pinching Antenna Systems Using Convolutional Neural Network](https://arxiv.org/abs/2511.22328)
...
### [23] [A Bio-Inspired Whisker Sensor toward Underwater Flow Sensing in Darkness and Turbidity](https://arxiv.org/abs/2511.22353)
...
### [24] [Adaptive Dual-Windowing Strategies for Multi-Target Detection in OFDM ISAC](https://arxiv.org/abs/2511.22458)
...
### [25] [Learning to Count Targets from Dual-Window: A CNN Approach for OFDM ISAC](https://arxiv.org/abs/2511.22473)
*Ali Al Khansa*
...
### [26] [Interference and Multipath Resilient ToA Estimation](https://arxiv.org/abs/2511.22629)
...
### [27] [Enabling Full-Duplex LEO Satellite Systems with Non-Reciprocal BD-RIS-Assisted Beamforming](https://arxiv.org/abs/2511.22525)
...
### [28] [EMF-Compliant Power Control in Cell-Free Massive MIMO: Model-Based and Data-Driven Approaches](https://arxiv.org/abs/2511.23357)
...
### [29] [Advances in electromagnetic techniques for subsurface infrastructure detection: A comprehensive review of methods, challenges, and innovations](https://arxiv.org/abs/2511.22673)
...
### [30] [Rethinking Signaling Design for ISAC: From Pilot-Based to Payload-Based Sensing](https://arxiv.org/abs/2511.22703)
...
### [31] [FPGA-Enabled Modulo ADC with x100 Dynamic-Range Expansion: Hardware Design and Performance Evaluation](https://arxiv.org/abs/2511.22752)
...
### [32] [Moduli Selection in Robust Chinese Remainder Theorem: Closed-Form Solutions and Layered Design](https://arxiv.org/abs/2511.22757)
...
### [33] [Embodied Intelligent Wireless (EIW): Synesthesia of Machines Empowered Wireless Communications](https://arxiv.org/abs/2511.22845)
...
### [34] [RIS-Assisted Physical Layer Security: Artificial Noise-Driven Optimization and Measurements](https://arxiv.org/abs/2511.22910)
...
### [35] [RAG-Empowered LLM-Driven Dynamic Radio Resource Management in Open 6G RAN](https://arxiv.org/abs/2511.22933)
...
### [36] [DoA Estimation with Sparse Arrays: Effects of Antenna Element Patterns and Nonidealities](https://arxiv.org/abs/2511.23028)
...
### [37] [Harnessing Chaotic Signals for Wireless Information and Power Transfer](https://arxiv.org/abs/2511.23049)
...
### [38] [What If They Took the Shot? A Hierarchical Bayesian Framework for Counterfactual Expected Goals](https://arxiv.org/abs/2511.23072)
...
### [39] [Physical Layer Security with Artificial Noise in MIMO Pinching-Antenna Systems](https://arxiv.org/abs/2511.23079)
...
### [40] [Joint Optimization of Pilot Length, Pilot Assignment, and Power Allocation for Cell-free MIMO Systems with Graph Neural Networks](https://arxiv.org/abs/2511.23128)
...
### [41] [Strategies to Minimize Out-of-Distribution Effects in Data-Driven MRS Quantification](https://arxiv.org/abs/2511.23135)
...
### [42] [Data-Efficient Motor Condition Monitoring with Time Series Foundation Models](https://arxiv.org/abs/2511.23177)
...
### [43] [Near-Field Channel Estimation and Joint Angle-Range Recovery in XL-MIMO Systems: A Gridless Super-Resolution Approach](https://arxiv.org/abs/2511.23187)
*Feng Xi,Dehui Yang*
...
### [44] [A Framework for Statistical Geometric Channel Model for ISAC Systems](https://arxiv.org/abs/2511.23201)
...
### [45] [Robust HRRP Recognition under Interrupted Sampling Repeater Jamming using a Prior Jamming Information-Guided Network](https://arxiv.org/abs/2511.23256)
...
### [46] [Hierarchical Feature Integration for Multi-Signal Automatic Modulation Recognition](https://arxiv.org/abs/2511.23258)
...
### [47] [Compensation of correlated autoregressive clock jitter in arrays of Analog-to-Digital Converters](https://arxiv.org/abs/2511.23351)
...
### [48] [Sensing and Understanding the World over Air: A Large Multimodal Model for Mobile Networks](https://arxiv.org/abs/2511.21707)
...
### [49] [Secure Command, Control and Communications Systems (C3) for Army UxVs](https://arxiv.org/abs/2511.21936)
...
### [50] [Resilient and Reliable Cloud Network Control for Mission-Critical Latency-Sensitive Service Chains](https://arxiv.org/abs/2511.21960)
...
### [51] [AutoRec: Accelerating Loss Recovery for Live Streaming in a Multi-Supplier Market](https://arxiv.org/abs/2511.22046)
...
### [52] [Optimizing NetGPT via Routing-Based Synergy and Reinforcement Learning](https://arxiv.org/abs/2511.22217)
...
### [53] [Semantic-Aware Caching for Efficient Image Generation in Edge Computing](https://arxiv.org/abs/2511.22421)
...
### [54] [Day in the Life of RIPE Atlas: Operational Insights and Applications in Network Measurements](https://arxiv.org/abs/2511.22474)
...
### [55] [RetryGuard: Preventing Self-Inflicted Retry Storms in Cloud Microservices Applications](https://arxiv.org/abs/2511.23278)
...
### [56] [Performance Evaluation of Multi-Armed Bandit Algorithms for Wi-Fi Channel Access](https://arxiv.org/abs/2511.23352)
...
### [57] [Joint Resource Allocation to Transparently Integrate 5G TDD Uplink with Time-Aware TSN](https://arxiv.org/abs/2511.23373)
