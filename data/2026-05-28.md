...
### [5] [Characterizing the Configuration of Starlink Queuing](https://arxiv.org/abs/2605.27717)
...
### [6] [A Vertical Look at UAV Connectivity in the Wild: Cellular vs. Starlink, 3D Characterization, and Performance Prediction](https://arxiv.org/abs/2605.27755)
...
### [7] [A Preliminary Assessment of Midhaul Links at 140 GHz using Ray-Tracing](https://arxiv.org/abs/2605.27771)
...
### [8] [Throughput-Optimized Networks at Scale](https://arxiv.org/abs/2605.27963)
...
### [9] [Kernel-Level Per-Slice UPF Latency Measurement in Containerised 5G Core Networks](https://arxiv.org/abs/2605.28185)
...
### [10] [Automated Heuristic Design for Network Operations](https://arxiv.org/abs/2605.28197)
...
### [11] [A Goal-Oriented Networking Approach for Intelligent IoT Service Deployment](https://arxiv.org/abs/2605.28502)
...
### [12] [DSRDM: Digital Signal Recovery Diffusion Model for Semantic Communications](https://arxiv.org/abs/2605.27730)
*Zhigang Yan,Dong Li*
...
### [13] [Decoupled Delay-Doppler and Angle Estimation in BD-RIS Sensing via Nested Tucker Decomposition](https://arxiv.org/abs/2605.27753)
...
### [14] [Automatic Attenuation Control for Mitigating Photon-Counting Saturation in SPAD-based Optical Wireless Communications](https://arxiv.org/abs/2605.27798)
...
### [15] [Movable Antenna Enhanced Dual-Functional Radar-Communication: A Symbol-Level Precoding Approach](https://arxiv.org/abs/2605.27839)
...
### [16] [Tensor Train Decomposition Based Noise Reduction and Enhanced Parameter Estimation for FMCW MIMO Radar Systems](https://arxiv.org/abs/2605.28180)
...
### [17] [Cross-Predictive Sparse Bayesian Learning with Application to XL-MIMO Channel Estimation](https://arxiv.org/abs/2605.28182)
...
### [18] [Spatiotemporal Tracking in Cooperative ISAC Networks: A Stochastic Geometry Framework](https://arxiv.org/abs/2605.28191)
...
### [19] [A Lightweight Method for Multiple Signal Direction Estimation with Adaptive Notch Filters](https://arxiv.org/abs/2605.28361)
*Burak Soner*
...
### [20] [A Gray-Box Approach for Decentralized Grid-Equivalent Model Identification](https://arxiv.org/abs/2605.28403)
...
### [21] [A Unified Maximum-Likelihood Framework for 3D InISAR Phase Unwrapping with Outlier Rejection](https://arxiv.org/abs/2605.28431)
...
### [22] [Transformer-Based Heartbeat Monitoring with FMCW Radar Under Random Body Motion](https://arxiv.org/abs/2605.28432)
...
### [23] [Experimental Characterization of a Multifunction X-Band AESA Radar Demonstrator](https://arxiv.org/abs/2605.28434)
...
### [24] [A Unified Framework for Unbiased Non-Coherent Over-the-Air Computation](https://arxiv.org/abs/2605.28453)
...
### [25] [Channel Measurements and Characterization with Phase Drift Compensation for Outdoor 330-360 GHz MIMO Communications](https://arxiv.org/abs/2605.28514)
...
### [26] [On Unified CRLB Framework from Generic Signals to ISAC Waveforms with Virtual Array Sensing](https://arxiv.org/abs/2605.28547)
...
### [27] [Unified Analytical Framework for SPAD Array Receivers with Dead-Time-Induced Blocking Loss and Inter-Symbol Interference in PAM-OWC Systems](https://arxiv.org/abs/2605.28560)
*Chen Wang,Zhiyong Xu,Jingyuan Wang,Jianhua Li,Weifeng Mou,Huatao Zhu*
