...
### [7] [Collaborative Intelligence for UAV-Satellite Network Slicing: Towards a Joint QoS-Energy-Fairness MADRL Optimization](https://arxiv.org/abs/2512.08322)
...
### [8] [Multi-Agent Deep Reinforcement Learning for Collaborative UAV Relay Networks under Jamming Atatcks](https://arxiv.org/abs/2512.08341)
...
### [9] [Turning Threat into Opportunity: DRL-Powered Anti-Jamming via Energy Harvesting in UAV-Disrupted Channels](https://arxiv.org/abs/2512.08351)
...
### [10] [Improvement and Stabilization of Output Voltages in a Vertical Tidal Turbine Using Intelligent Control Strategies](https://arxiv.org/abs/2512.08416)
...
### [11] [Inferring Causal Relationships to Improve Caching for Clients with Correlated Requests: Applications to VR](https://arxiv.org/abs/2512.08626)
...
### [12] [ITU-T Y.2325: NGN Evolution Towards Future](https://arxiv.org/abs/2512.08695)
...
### [13] [WikIPedia: Unearthing a 20-Year History of IPv6 Client Addressing](https://arxiv.org/abs/2512.08808)
*Erik Rye,Dave Levin*
...
### [14] [Signal and Noise Classification in Bio-Signals via unsupervised Machine Learning](https://arxiv.org/abs/2512.07851)
*Sansrit Paudel*
...
### [15] [Polarization-Diversity-Based Rotation Sensing Methodology Using COTS UHF RFID Tags](https://arxiv.org/abs/2512.08069)
...
### [16] [Millimeter-Wave True-Time Delay Array Beamforming with Robustness to Mobility](https://arxiv.org/abs/2512.08162)
...
### [17] [Metasurfaces Enable Active-Like Passive Radar](https://arxiv.org/abs/2512.08208)
...
### [18] [1024-Channel 0.8V 23.9-nW/Channel Event-based Compute In-memory Neural Spike Detector](https://arxiv.org/abs/2512.08244)
...
### [19] [Geometry-Aligned Differential Privacy for Location-Safe Federated Radio Map Construction](https://arxiv.org/abs/2512.08263)
...
### [20] [Self-Alignment Resonant Beam Empowers Beamforming without Estimation and Control for 6G IoT](https://arxiv.org/abs/2512.08386)
...
### [21] [Hybrid Fuzzy Logic and Shading-Aware Particle Swarm Optimization for Dynamic Photovoltaic Shading Faults Mitigation](https://arxiv.org/abs/2512.08419)
...
### [22] [Aliasing in Near-Field Array Ambiguity Functions: a Spatial Frequency-Domain Framework](https://arxiv.org/abs/2512.08469)
...
### [23] [LoS+NLoS Holographic MIMO: Analysis and Application of Wavenumber-Division Multiplexing](https://arxiv.org/abs/2512.08509)
...
### [24] [Beyond Diagonal RIS-assisted MIMO Transmission: Beamforming Gain and Capacity Optimization](https://arxiv.org/abs/2512.08516)
...
### [25] [Delay-Oriented Distributed Scheduling with TransGNN](https://arxiv.org/abs/2512.08799)
...
### [26] [Contextual Bandits and Reconfigurable Intelligent Surfaces for Predictive LTM Handover Decisions](https://arxiv.org/abs/2512.08556)
...
### [27] [Applications of Singular Entropy to Signals and Singular Smoothness to Images](https://arxiv.org/abs/2512.08717)
...
### [28] [RF sensing with dense IoT network graphs: An EM-informed analysis](https://arxiv.org/abs/2512.08746)
...
### [29] [Evaluating the Deformation Measurement Accuracy Using Low-SNR Radars for Future InSAR Missions](https://arxiv.org/abs/2512.08779)
...
### [30] [A Fast Broadband Beamspace Transformation](https://arxiv.org/abs/2512.08887)
...
### [31] [Timing-Error Optimized Architecture for Current-Steering DACs](https://arxiv.org/abs/2512.08903)
...
### [32] [Architecture Design for Rise/Fall Asymmetry Glitch Minimization in Current-Steering DACs](https://arxiv.org/abs/2512.08909)
*Ramin Babaee,Shahab Oveis Gharan,Martin Bouchard*
