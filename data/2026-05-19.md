...
### [16] [End-to-End Simulation of 5G NR Integrated Access and Backhaul Networks for Remote Maritime Connectivity](https://arxiv.org/abs/2605.16531)
...
### [17] [Re/Imagining Smart Home Automation Framework in the Era of 6G-Enabled Smart Cities](https://arxiv.org/abs/2605.16599)
...
### [18] [Transformer-Based MCS Prediction for 5G Multicast-Broadcast Services (MBS)](https://arxiv.org/abs/2605.16735)
...
### [19] [SpaceMoE: Towards Orbital General Intelligence with Distributed Mixture-of-Experts Inference](https://arxiv.org/abs/2605.16849)
...
### [20] [Escape from Callback Hell! A New Programming Paradigm for Network Simulation](https://arxiv.org/abs/2605.16897)
...
### [21] [Wi-Fi HaLow (IEEE 802.11ah) for Long-Range Monitoring Links: Point-to-Point NLoS/LoS and LoS Mesh Field Characterization](https://arxiv.org/abs/2605.17349)
...
### [22] [Enhancing Network Resilience via Graph-Based Anomaly Detection in Sovereign Functions](https://arxiv.org/abs/2605.17716)
...
### [23] [CA3D: Computing Accessibility-Aware Cooperative 3D Deployment of Multiple UAVs](https://arxiv.org/abs/2605.17852)
...
### [24] [ASTRA: Asynchronous Age-Aware Satellite Random Access via Mean-Field Control](https://arxiv.org/abs/2605.18282)
...
### [25] [Enabling Agile Ambient IoT Networking via a Parameterized Hybrid Radio](https://arxiv.org/abs/2605.18314)
...
### [26] [Collaborative Air-Ground Sensing, Communication, Computing, Storage, and Intelligence for Low-Altitude Economy](https://arxiv.org/abs/2605.18503)
...
### [27] [Modulation Feature Enhancement with a Multi-Stage Attention Network for Underwater Acoustic Target Recognition](https://arxiv.org/abs/2605.16304)
...
### [28] [Learning Displacement-Aware WiFi Representations for Weakly Supervised Relative Localization](https://arxiv.org/abs/2605.16357)
...
### [29] [Overcoming the Intrinsic Performance Limitations of MEMS IMU via Diffusion-Based Generative Learning](https://arxiv.org/abs/2605.16391)
...
### [30] [One-hot Coding-based URA with RFFI-Enabled Message Authentication](https://arxiv.org/abs/2605.16437)
...
### [31] [Q-Enhanced SH-SAW Ladder Filter in Thin-Film Lithium Tantalate Using Bartlett Apodization](https://arxiv.org/abs/2605.16586)
...
### [32] [Uplink Channel Estimation for Multi-User MISO Systems Assisted by a Fluid Reconfigurable Intelligent Surface](https://arxiv.org/abs/2605.16609)
...
### [33] [Against the Monolithic Wireless World Model: Why NextG Needs Composable and Agentic Intelligence](https://arxiv.org/abs/2605.16689)
...
### [34] [Constellation-Independent Range Estimation in Payload-Based OFDM-ISAC](https://arxiv.org/abs/2605.16831)
...
### [35] [Performance Analysis of Movable Antenna Arrays](https://arxiv.org/abs/2605.16907)
...
### [36] [Analysis of Fluid Antenna Systems with Continuous Positioning and Spatial Correlation](https://arxiv.org/abs/2605.16920)
*Gayani Siriwardana,Peter J. Smith,Himal A. Suraweera,Rajitha Senanayake*
...
### [37] [Estimating Target Doppler in Unsynchronized Multistatic ISAC Deployments with Mobile Nodes](https://arxiv.org/abs/2605.16934)
...
### [38] [UPSim: UxNB Propagation Simulator for 3D Map-Driven FR3 Deployments](https://arxiv.org/abs/2605.17378)
*Evgenii Vinogradov*
...
### [39] [Design and Practical Validation of a Novel Modulation Scheme for RIS Detection and Identification](https://arxiv.org/abs/2605.17009)
...
### [40] [Connectionless Bluetooth LE Channel Sounding via PAwR for Scalable and Energy-Efficient Ranging](https://arxiv.org/abs/2605.17094)
...
### [41] [A reversed solar illumination dependence of unintended emission from Starlink Direct-to-Cell satellites at 72-234 MHz with the EDA2](https://arxiv.org/abs/2605.17150)
...
### [42] [Leveraging Deep Reinforcement Learning for Clustered Cell-Free Networking Over User Mobility](https://arxiv.org/abs/2605.17266)
...
### [43] [FPGA-Based Experimental Analysis of Fixed-Point Precision Impact on SOP Estimation in Coherent Communications Receivers](https://arxiv.org/abs/2605.17521)
...
### [44] [DFT-s-OFDM with Chirping for Integrated Sensing and Communications in 6G and Beyond](https://arxiv.org/abs/2605.17612)
...
### [45] [A Framework of Near-Field Communication with Different Array Geometries: Analysis, Optimization, and General Channel Estimation Algorithms Based on Deep Learning](https://arxiv.org/abs/2605.17690)
...
### [46] [Observation Modeling of Reference--Background Residuals in Single-Snapshot FDA-MIMO-GPR](https://arxiv.org/abs/2605.17728)
*Yisu Yan,Jifeng Guo*
...
### [47] [Curriculum-Guided Heterogeneous Multi-Agent Intelligence for Multi-UAV Cooperative ISAC](https://arxiv.org/abs/2605.17905)
...
### [48] [A Computationally Efficient Reciprocal Effective Roughness Model for Diffuse Scattering](https://arxiv.org/abs/2605.17988)
...
### [49] [PRiSE-EEG: A Prior-Guided Foundation Model with Depth-Stratified Experts for Cross-Paradigm EEG Representation Learning](https://arxiv.org/abs/2605.18085)
...
### [50] [From Coverage to Sensing: ISAC meets FR3](https://arxiv.org/abs/2605.18120)
...
### [51] [R$^{2}$Net: 2D Deep Residual Learning with Height Embedding for 3D Radio Map Estimation](https://arxiv.org/abs/2605.18127)
...
### [52] [Buffer-Parameterized Machine Learning Surrogate Models for Cross-Technology Signal Integrity Analysis and Optimization](https://arxiv.org/abs/2605.18170)
...
### [53] [Fast 5G Signal Acquisition by Using Non-Uniform Sampling](https://arxiv.org/abs/2605.18189)
...
### [54] [Subject-Specific Analysis of Self-Initiated Attention Shifts from EEG with Controlled Internal and External Attention Conditions](https://arxiv.org/abs/2605.18251)
...
### [55] [Mixture-of-Experts Diffusion Models for Adaptive Massive MIMO Channel Estimation via Variational Bayesian Inference](https://arxiv.org/abs/2605.18325)
...
### [56] [Multi-dimensional hierarchical dictionary search for large MIMO-OFDM systems](https://arxiv.org/abs/2605.18363)
...
### [57] [Baseband-Efficient WMMSE Precoding: From a Signal Weighting Cost Perspective](https://arxiv.org/abs/2605.18368)
...
### [58] [A Fast Robust Adaptive filter using Improved Data-Reuse Method](https://arxiv.org/abs/2605.18417)
...
### [59] [Sense Smarter, Think Better: Edge Perception for Next-Generation Networks](https://arxiv.org/abs/2605.18457)
...
### [60] [Movable Antenna-Enabled Integrated Sensing and Communication in Low-Altitude UAV Networks](https://arxiv.org/abs/2605.18486)
...
### [61] [Sparse Channel Estimation for Pixel Antennas: Addressing the Pilot Rank Deficiency](https://arxiv.org/abs/2605.18516)
...
### [62] [Learned Memory Attenuation in Sage-Husa Kalman Filters for Robust UAV State Estimation](https://arxiv.org/abs/2605.18704)
