...
### [1] [A Pre-trained EEG-to-MEG Generative Framework for Enhancing BCI Decoding](https://arxiv.org/abs/2602.06990)
...
### [2] [Adaptive Temporal Dynamics for Personalized Emotion Recognition: A Liquid Neural Network Approach](https://arxiv.org/abs/2602.06997)
...
### [3] [OTFS-based Integrated Positioning and Communication Systems with Low-Resolution ADCs](https://arxiv.org/abs/2602.07001)
...
### [4] [Behavior Score Prediction in Resting-State Functional MRI by Deep State Space Modeling](https://arxiv.org/abs/2602.07131)
...
### [5] [ML-Enabled Deformable Matched Filters for Bandlimitation Compensation in Free-Space Optics](https://arxiv.org/abs/2602.07169)
*Paul Anthony Haigh*
...
### [6] [Spectrum Coexistence, Network Dimensioning, and Cell-Free Architectures in 5G and 5G-Advanced Wireless Networks](https://arxiv.org/abs/2602.07270)
...
### [7] [Wireless Context Engineering for Efficient Mobile Agentic AI and Edge General Intelligence](https://arxiv.org/abs/2602.07321)
...
### [8] [Pulse Shaping Filter Design for Zak-OTFS](https://arxiv.org/abs/2602.07350)
...
### [9] [Message Passing based Parameter Estimation in Cooperative MIMO-OFDM ISAC Systems](https://arxiv.org/abs/2602.07365)
...
### [10] [Optimal Low-Dimensional Structures of ISAC Beamforming: Theory and Efficient Algorithms](https://arxiv.org/abs/2602.07502)
...
### [11] [Beyond $λ/2$: Can Arbitrary EMVS Arrays Achieve Unambiguous NLOS Localization?](https://arxiv.org/abs/2602.07515)
...
### [12] [Fractional Filtering and Anomaly-Guided Diagnostics: The Local Damage Mode Extractor (LDME) for Early Gear Fault Detection](https://arxiv.org/abs/2602.07527)
*Yaakoub Berrouche*
...
### [13] [A Scalable Cloud-Edge Collaborative CKM Construction Framework Enabled by a Foundation Prior Model](https://arxiv.org/abs/2602.07586)
...
### [14] [Code-Weight Sphere Decoding](https://arxiv.org/abs/2508.19631)
...
### [15] [MI-ISAC: Magneto-Inductive Integrated Sensing and Communication in the Reactive Near-Field for RF-Denied Environments](https://arxiv.org/abs/2602.07714)
...
### [16] [Deep Reinforcement Learning for Interference Suppression in RIS-Aided Space-Air-Ground Integrated Networks](https://arxiv.org/abs/2602.06982)
...
### [17] [Joint Simplicial Complex Learning via Binary Linear Programming](https://arxiv.org/abs/2602.07896)
...
### [18] [End-to-End Secure Connection Probability in MultiLayer Networks with Heterogeneous Rician Fading](https://arxiv.org/abs/2602.07959)
...
### [19] [Adjustment of Cluster-Then-Predict Framework for Multiport Scatterer Load Prediction](https://arxiv.org/abs/2602.08129)
...
### [20] [AFDM: Evolving OFDM Towards 6G+](https://arxiv.org/abs/2602.08163)
...
### [21] [An Experimental Study on Fine-Grained Bistatic Sensing of UAV Trajectory via Cellular Downlink Signals](https://arxiv.org/abs/2602.08203)
...
### [22] [LocDreamer: World Model-Based Learning for Joint Indoor Tracking and Anchor Scheduling](https://arxiv.org/abs/2602.08204)
...
### [23] [Riemannian Manifold Optimization for Advanced Wireless Communications: Fundamentals and Applications](https://arxiv.org/abs/2602.08225)
...
### [24] [Towards Optimal Semantic Communications: Reconsidering the Role of Semantic Feature Channels](https://arxiv.org/abs/2602.08260)
...
### [25] [Beam Alignment in Multipath Environments for Integrated Sensing and Communication using Bandit Learning](https://arxiv.org/abs/2602.08380)
...
### [26] [IEEE 802.11ad-Aided 5-D Sensing with a UAV Swarm in Urban Environment](https://arxiv.org/abs/2602.08396)
...
### [27] [Movable Antenna Enabled Reconfigurable Array Topologies for Structured Beam Communications](https://arxiv.org/abs/2602.08409)
...
### [28] [Reconfigurable Low-Complexity Architecture for High Resolution Doppler Velocity Estimation in Integrated Sensing and Communication System](https://arxiv.org/abs/2602.08415)
...
### [29] [Symbol Rate Maximization in Rolling-Shutter OCC: Design and Implementation Considerations](https://arxiv.org/abs/2602.08474)
...
### [30] [Radar Operating Metrics and Network Throughput for Integrated Sensing and Communications in Millimeter-wave Urban Environments](https://arxiv.org/abs/2602.08495)
...
### [31] [DNS: Data-driven Nonlinear Smoother for Complex Model-free Process](https://arxiv.org/abs/2602.08560)
...
### [32] [RFSoC-Based Integrated Navigation and Sensing Using NavIC](https://arxiv.org/abs/2602.08596)
...
### [33] [Ziv-Zakai Bound for Near-Field Localization and Sensing](https://arxiv.org/abs/2602.08609)
...
### [34] [Improving Reliability of Hybrid Bit-Semantic Communications for Cellular Networks](https://arxiv.org/abs/2602.08697)
...
### [35] [Joint Channel Sounding and Source-Channel Coding for MIMO-OFDM Systems: Deep Unified Encoding and Parallel Flow-Matching Decoding](https://arxiv.org/abs/2602.08795)
...
### [36] [Denoise Stepwise Signals by Diffusion Model Based Approach](https://arxiv.org/abs/2602.08904)
...
### [37] [Mirage: Transmitting a Video as a Perceptual Illusion for 50,000X Speedup](https://arxiv.org/abs/2602.07396)
...
### [38] [Interference Propagation Analysis for Large-Scale Multi-RIS-Empowered Wireless Communications:An Epidemiological Perspective](https://arxiv.org/abs/2602.07922)
...
### [39] [Trajectory-Aware Multi-RIS Activation and Configuration: A Riemannian Diffusion Method](https://arxiv.org/abs/2602.07937)
...
### [40] [DHEA-MECD: An Embodied Intelligence-Powered DRL Algorithm for AUV Tracking in Underwater Environments with High-Dimensional Features](https://arxiv.org/abs/2602.07947)
...
### [41] [NeuroScaler: Towards Energy-Optimal Autoscaling for Container-Based Services](https://arxiv.org/abs/2602.08191)
...
### [42] [MonkeyTree: Near-Minimal Congestion for Multi-tenant Training via Migration](https://arxiv.org/abs/2602.08296)
...
### [43] [PACC: Protocol-Aware Cross-Layer Compression for Compact Network Traffic Representation](https://arxiv.org/abs/2602.08331)
...
### [44] [Decentralized Spatial Reuse Optimization in Wi-Fi: An Internal Regret Minimization Approach](https://arxiv.org/abs/2602.08456)
...
### [45] [From Raw Data to Shared 3D Semantics: Task-Oriented Communication for Multi-Robot Collaboration](https://arxiv.org/abs/2602.08624)
...
### [46] [6G-Bench: An Open Benchmark for Semantic Communication and Network-Level Reasoning with Foundation Models in AI-Native 6G Networks](https://arxiv.org/abs/2602.08675)
...
### [47] [Rethinking IPv6 Defense: A Unified Edge-Centric Zero-Trust Data-Plane Architecture](https://arxiv.org/abs/2602.08891)
...
### [48] [Zero Trust for Multi-RAT IoT: Trust Boundary Management in Heterogeneous Wireless Network Environments](https://arxiv.org/abs/2602.08989)
*Jonathan Shelby*
...
### [49] [Performance Evaluation of V2X Communication Using Large-Scale Traffic Data](https://arxiv.org/abs/2602.07244)
...
### [50] [Expected Recovery Time in DNA-based Distributed Storage Systems](https://arxiv.org/abs/2602.07601)
...
### [51] [Data Compression with Stochastic Codes](https://arxiv.org/abs/2602.07635)
...
### [52] [Capacity Scaling Laws for Boundary-Induced Drift-Diffusion Noise Channels](https://arxiv.org/abs/2602.07866)
*Yen-Chi Lee*
...
### [53] [Deep learning based Channel Estimation and Beamforming in Movable Antenna Systems](https://arxiv.org/abs/2602.07870)
...
### [54] [Deep Variable-Length Feedback Codes](https://arxiv.org/abs/2602.07881)
*Yu Ding,Yulin Shao*
...
### [55] [Rich-ARQ: From 1-bit Acknowledgment to Rich Neural Coded Feedback](https://arxiv.org/abs/2602.07886)
...
### [56] [OFDM Enabled Over-the-Air Computation Systems with Two-Dimensional Fluid Antennas](https://arxiv.org/abs/2602.07953)
...
### [57] [Tighter Information-Theoretic Generalization Bounds via a Novel Class of Change of Measure Inequalities](https://arxiv.org/abs/2602.07999)
...
### [58] [Term Coding and Dispersion: A Perfect-vs-Rate Complexity Dichotomy for Information Flow](https://arxiv.org/abs/2602.08110)
*Søren Riis*
...
### [59] [Optimal Transmit Beamforming for MIMO ISAC with Unknown Target and User Locations](https://arxiv.org/abs/2602.08255)
...
### [60] [Hierarchical Subcode Ensemble Decoding of Polar Codes](https://arxiv.org/abs/2602.08391)
...
### [61] [Multipoint Code-Weight Sphere Decoding: Parallel Near-ML Decoding for Short-Blocklength Codes](https://arxiv.org/abs/2602.08501)
*Yubeen Jo,Geon Choi,Yongjune Kim,Namyoon Lee*
...
### [62] [Reliable one-bit quantization of bandlimited graph data via single-shot noise shaping](https://arxiv.org/abs/2602.08669)
...
### [63] [Trellis codes with a good distance profile constructed from expander graphs](https://arxiv.org/abs/2602.08718)
...
### [64] [Clique-Based Deletion-Correcting Codes via Penalty-Guided Clique Search](https://arxiv.org/abs/2602.08952)
...
### [65] [Information Theoretic Modeling of Interspecies Molecular Communication](https://arxiv.org/abs/2602.07474)
...
### [66] [Transformer-based Hybrid Beamforming with Dynamic Subarray for Near-Space Airship-Borne Communications](https://arxiv.org/abs/2602.07509)
