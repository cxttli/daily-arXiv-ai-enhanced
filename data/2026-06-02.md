...
### [13] [FlexLink: Decoupling Control and Data Beams for Next-Generation Wideband Networks](https://arxiv.org/abs/2606.01454)
...
### [14] [Performance of DF Multihop Networks with TAS/GSC over Nakagami-m Fading Channels](https://arxiv.org/abs/2606.00598)
...
### [15] [Bending beams behind corners: mechanisms, challenges and capabilities for wireless connectivity](https://arxiv.org/abs/2606.00678)
...
### [16] [Rethinking NB-IoT Downlink Synchronization for LEO-NTN: A Novel Overhead Reduction Method and Measurement-Based Evaluation](https://arxiv.org/abs/2606.00701)
...
### [17] [Toward Agile and Cooperative LEO Satellite Beam-Hopping Networks: Paradigms, Challenges, and Opportunities](https://arxiv.org/abs/2606.00743)
...
### [18] [Optimal Routing and Link Configuration for Covert Heterogeneous Wireless Networks in the Presence of a Friendly Jammer](https://arxiv.org/abs/2606.00848)
...
### [19] [Lossy Microwave Linear Analog Computer (MiLAC) for Future MIMO: Learning-based Architecture Designs for Spectral and Energy Efficiency Maximization](https://arxiv.org/abs/2606.02369)
...
### [20] [TenSIM: Tensor-Based Channel Estimation for MIMO Systems with Stacked Intelligent Metasurfaces](https://arxiv.org/abs/2606.00917)
...
### [21] [Electromagnetic Digital Twin-Enabled Closed-Loop Beam Management in ISAC Systems](https://arxiv.org/abs/2606.00977)
...
### [22] [Multicast Capacity of XL-RIS Assisted Hybrid Near- and Far-Field mmWave Communications](https://arxiv.org/abs/2606.01133)
...
### [23] [Flexible Rate-Splitting for Joint Unicast and Multi-Group Multicast Transmission in RIS-Assisted mmWave Networks](https://arxiv.org/abs/2606.01144)
...
### [24] [MAC Performance and Algorithmic Optimization in Matrix Multiplication Workloads](https://arxiv.org/abs/2606.01174)
...
### [25] [IO Pad Integrity in Energy-Efficient Neuromorphic Chips](https://arxiv.org/abs/2606.01181)
*Arfan Ghani*
...
### [27] [Experimental Demonstration of a Real Time Wideband OFDM Generation in Sub-THz](https://arxiv.org/abs/2606.01191)
...
### [28] [RAG-driven Multi-Agent LLM Framework with Task Decomposition for Beyond 5G Auto-Configuration](https://arxiv.org/abs/2606.01222)
...
### [29] [SweetFruit: A Two-Stage Mobile Sensing System for Real-Time Fruit Sugar Estimation](https://arxiv.org/abs/2606.01231)
...
### [30] [Online Censoring-Based Widely Linear Total Least lncosh Method for Improved Power System Frequency Estimation](https://arxiv.org/abs/2606.01233)
...
### [31] [Beyond the RF Paradigm: Rydberg Atomic Receivers for Next-Generation IoT](https://arxiv.org/abs/2606.01263)
...
### [32] [Adaptive UAV Communications for URLLC: From Preplanned Designs to Real-Time Intelligence](https://arxiv.org/abs/2606.01391)
...
### [33] [Power consumption and spectral efficiency analysis for uplink analog radio-over-fiber](https://arxiv.org/abs/2606.01411)
...
### [34] [Spatially Distributed Task-Oriented Compression for Multi-Emitter Localization and Characterization with Spectral Overlap](https://arxiv.org/abs/2606.01446)
...
### [50] [Diffusion-Based Heart Sound Generation: Evaluation with Physiological Signal Metrics, Classifiers, and Expert Listening](https://arxiv.org/abs/2606.02448)
...
### [51] [GNN-based Online Beamforming Design for HAPS-Assisted NTN](https://arxiv.org/abs/2606.00244)
...
### [52] [KISS: Keeping it Simple and Slotted when Learning to Communicate over Wireless](https://arxiv.org/abs/2606.00266)
...
### [53] [AgentxGCore: Agentic AI for Next-Generation Mobile Core Network](https://arxiv.org/abs/2606.00417)
...
### [54] [XOR Bidding and Knapsack Formulations for HPC Network Resource Allocation](https://arxiv.org/abs/2606.00490)
...
### [55] [SEArch: Optimistic Policy Selection Between Scene Noise and Drift for UAV Radar Search](https://arxiv.org/abs/2606.01325)
...
### [56] [Understanding Cross-Cloud Interconnects: Hands-On Measurements and Cost Optimization](https://arxiv.org/abs/2606.01440)
...
### [57] [A Reproducible UAV-Assisted VANET Dataset Generator for Fragmentation Risk Analysis in Intelligent Transportation Systems](https://arxiv.org/abs/2606.01488)
...
### [58] [mmAlert: A Simultaneous Device Localization and Target Tracking System via Cooperative Passive Sensing](https://arxiv.org/abs/2606.01653)
...
### [59] [A Unified E2E Energy Efficiency Testing Framework for Open RAN](https://arxiv.org/abs/2606.01931)
...
### [60] [Waiting at the front door: Continuous monitoring of latency in the host network stack](https://arxiv.org/abs/2606.02057)
...
### [61] [Statistically Robust Resource Block Allocation for Satellite Communications](https://arxiv.org/abs/2606.02124)
...
### [62] [Discovering Agents for Discovery: The Case for DNS](https://arxiv.org/abs/2606.02314)
...
### [63] [Certified Closed-Loop Control for Packet Networks: A Compositional Certification Framework](https://arxiv.org/abs/2606.02368)
...
### [64] [Quantum Simultaneous Information and Power Transfer: Capacity-Power Trade-offs in Discrete and Continuous Channels](https://arxiv.org/abs/2606.00406)
...
### [65] [Hybrid Bit and Semantic Communications for UAV-Enabled Wireless Power Transfer Networks: A Decision-Assisted Deep Reinforcement Learning Approach](https://arxiv.org/abs/2606.00668)
...
### [66] [Information-Theoretic Lower Bounds for Bit-Constrained Stochastic Optimization via a Reduction to Compressed Gaussian Mean Estimation](https://arxiv.org/abs/2606.00703)
*Munsik Kim*
...
### [67] [Rank Modulated Composite Encoding for Data Storage in DNA](https://arxiv.org/abs/2606.00978)
...
### [68] [Beam-focusing Analysis for Modular XL-arrays: Effect of Time Synchronization Errors](https://arxiv.org/abs/2606.01096)
...
### [69] [Cooperative Mitigation against Learning-Based Reactive Jammers: Analysis and SDR Validation](https://arxiv.org/abs/2606.01197)
...
### [70] [Finite-Resolution Information from Collision Statistics](https://arxiv.org/abs/2606.01218)
*Alexander J. Gates*
...
### [71] [Upper Bounds on Multiple $b$-Burst Deletion-Correcting Codes](https://arxiv.org/abs/2606.01245)
...
### [72] [Toward Reliable Semantic Communication: Beyond Average Performance](https://arxiv.org/abs/2606.01284)
...
### [73] [Digital Twin-Assisted Adaptive Multi-Agent DRL for Intelligent Spectrum and Resource Management in Open-RAN UAV-Enabled 6G Networks](https://arxiv.org/abs/2606.01324)
...
### [74] [Low-Subpacketization MIMO Coded Caching with Flexible Stream Allocation](https://arxiv.org/abs/2606.01353)
...
### [75] [Query-Limited Community Recovery in Stochastic Block Models](https://arxiv.org/abs/2606.02055)
...
### [76] [QEC and EAQEC Codes from Hermitian Sums and Hulls of Cyclic Codes over $\mathbb{F}_2 \times (\mathbb{F}_2+v\mathbb{F}_2)$](https://arxiv.org/abs/2606.02137)
...
### [77] [Rotatable Antenna-Enabled Satellite Communication: Joint Design of Boresight Alignment and Beam Tracking](https://arxiv.org/abs/2606.02193)
...
### [78] [Four constructions of self-dual binary cyclic codes with a lower bound on the minimum distances better than the square-root bound](https://arxiv.org/abs/2606.02262)
...
### [79] [Multidimensional Reconciliation in Continuous-Variable QKD: Review, Coding Schemes, and Open Source Simulation](https://arxiv.org/abs/2606.02323)
