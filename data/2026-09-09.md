...
### [30] [Hybrid Continuous DoA Estimation with Shared-Radius Co-Prime Circular Arrays](https://arxiv.org/abs/2609.08827)
*Keyvan Aghababaiyan*
...
### [31] [Variational Bayesian Data Detection for Multiuser MIMO Systems Corrupted by Phase Noises](https://arxiv.org/abs/2609.08252)
...
### [32] [Physics of Information Geometry - Part I: Principle of Least Action on the Probability Simplex](https://arxiv.org/abs/2609.08285)
...
### [33] [Convolutional Codes from Cyclic Codes with Guaranteed Free and Local Minimum Distances](https://arxiv.org/abs/2609.08296)
...
### [34] [Non-Coherent Over-the-Air Federated Learning: Protocol, Convergence, and Device Scheduling](https://arxiv.org/abs/2609.08312)
...
### [35] [Quantum Matrix-Product Codes: CSS-T Characterization and Maximality](https://arxiv.org/abs/2609.08520)
...
### [36] [The Fusion Frame Phase Retrieval](https://arxiv.org/abs/2609.08531)
...
### [37] [Sequential Lossy Compression With Causal Conditional Perception](https://arxiv.org/abs/2609.08611)
...
### [38] [Linear Programming Bounds for LCD Codes via Gauss Phases](https://arxiv.org/abs/2609.08662)
...
### [39] [A Note on Scaling in Randomly Rotated Quantization and Its Connection to the CDEF +1 Pythagorean Relation](https://arxiv.org/abs/2609.08759)
*Uri Erez*
...
### [40] [The Weight Spectrum of the Affine Grassmann Code $C^{\mathbb A}(3,6)$](https://arxiv.org/abs/2609.08784)
...
### [86] [WIP: Energy-Efficient LLM-Based Serving Cluster Formulation in Cell-Free Massive MIMO](https://arxiv.org/abs/2609.05725)
...
### [87] [SDN-Orchestrated Dual-Path 5G/SATCOM Maritime Communications for Carrier Strike Groups](https://arxiv.org/abs/2609.05729)
...
### [88] [Semantic Communication for Distributed Spectrum Monitoring over Unreliable Links](https://arxiv.org/abs/2609.05791)
...
### [89] [HalifaxDT: A Wireless Digital Twin from Open Geospatial Data](https://arxiv.org/abs/2609.05793)
...
### [90] [Comparative Performance of Graphene-Enabled Transmitarray Antenna and Reflectors for Wide-Angle Terahertz Beam Steering](https://arxiv.org/abs/2609.05803)
...
### [91] [Biased Backpressure Routing for Multihop Wireless Networks with Heterogeneous Interfaces](https://arxiv.org/abs/2609.05844)
...
### [92] [SLA-Safe Energy Control for AI-Native NG-RAN Using Stability-Aware Constrained PPO](https://arxiv.org/abs/2609.05861)
*Dharmendra Kumar*
...
### [93] [Programmable Data Plane Switch based Heavy Hitter Flow Detection using Packet-Count and Packet-Size features](https://arxiv.org/abs/2609.05998)
...
### [94] [Delay and Throughput Analysis of Computation Offloading in Mobile Edge Computing: A Queueing Network Approach](https://arxiv.org/abs/2609.06021)
...
### [95] [SESO-ISAC: Service-Aware End-to-End Sensing Orchestration for 6G ISAC](https://arxiv.org/abs/2609.06089)
...
### [96] [Rethinking Channel Charting: A Graph Perspective](https://arxiv.org/abs/2609.06204)
...
### [97] [Task-Oriented Semantic Communication for Hazard Warning and Remote Operation in Connected Vehicle Platoons](https://arxiv.org/abs/2609.06242)
...
### [98] [Exploring the Initial Performance of NB-IoT NTN over GEO: Measurement and Analysis](https://arxiv.org/abs/2609.06280)
...
### [99] [The LQ Digital Mode Family: Protocol Architecture and Reference Specification for Weak-Signal Communications](https://arxiv.org/abs/2609.06427)
*Luis Quesada*
...
### [100] [Measurement-Device Placement in MDI-QKD Networks with Minimal Trusted Relays](https://arxiv.org/abs/2609.06603)
...
### [101] [Enabling Emergency Communication via Semantic Radar-Centric ISAC](https://arxiv.org/abs/2609.06801)
...
### [102] [An FPGA-in-the-Loop Testbed for MU-MIMO OFDM Beamforming over Ray-Traced Wireless Channels](https://arxiv.org/abs/2609.06812)
...
### [103] [ASTRA: Low-Overhead Runtime Architecture for STReam Adaptation in Video Analytics](https://arxiv.org/abs/2609.07020)
...
### [104] [Ollama in the Wild: A Longitudinal Measurement of Exposed Ollama LLM Endpoints at Internet Scale](https://arxiv.org/abs/2609.07115)
...
### [105] [Det-5G: Closing the Determinism Gap in 5G-Advanced for Industrial Closed-Loop Control](https://arxiv.org/abs/2609.07386)
*Adnan Aijaz*
...
### [106] [Blockchain-based Proportional Fair Scheduling for Multi-Operator O-RAN](https://arxiv.org/abs/2609.07473)
...
### [107] [Perception-Aware Joint Power and Sub-Band Allocation for 6G In-Body Subnetworks](https://arxiv.org/abs/2609.07519)
...
### [108] [How Bitcoin Forms Its Network: Peer-Table Sampling and Structural Properties](https://arxiv.org/abs/2609.07609)
...
### [109] [Real-Time dApps for AI-RAN: Measured Interface Requirements for Inline PHY and Slot-Level Control](https://arxiv.org/abs/2609.07805)
...
### [110] [The OCUDU dApp Platform: An Open Runtime and E3 Interface for Real-Time AI-RAN](https://arxiv.org/abs/2609.07843)
*Timothy O'Shea,Matthew Pennybacker,Andriy Kharchenko*
...
### [111] [Movable Antennas Enabled Wireless Powered Networks: Principles and Technologies](https://arxiv.org/abs/2609.08042)
...
### [112] [6SEVEN: System for EValuating IPv6 ENumeration algorithms](https://arxiv.org/abs/2609.08098)
...
### [113] [Information-Entropy-Driven Fault Propagation Modeling for Probabilistic Network Performance Prediction](https://arxiv.org/abs/2609.08143)
...
### [114] [QoS-Aware RACH Preamble Slicing via Quota-Projected Branching Deep Reinforcement Learning](https://arxiv.org/abs/2609.08199)
...
### [115] [Toward Fully Autonomous 6G Networks: AI-driven Operational Efficiency and Optimization](https://arxiv.org/abs/2609.08426)
...
### [116] [AI-Native Orchestration in the 6G Continuum: Evolving Operator Platforms with Agentic AI](https://arxiv.org/abs/2609.08441)
...
### [117] [CleanCity-BinSense: An IoT-Enabled Smart Waste Management System with Configurable Real-Time Fill Monitoring and Nearest-Neighbor Route Optimization](https://arxiv.org/abs/2609.08527)
