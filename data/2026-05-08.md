...
### [2] [SixGman: An Open-Source Planner for Fixed 6G Hierarchical Optical Access-Core Networks](https://arxiv.org/abs/2605.05763)
...
### [3] [Bridging the 6G Gap: Scaling Sustainable ROADM-Based IP-over-WDM via DSCM-Enabled Point-to-Multipoint Designs](https://arxiv.org/abs/2605.05793)
...
### [4] [Comparative Analysis of Direct-to-Cell (D2C) and 3GPP Non-Terrestrial Networks (NTN) for Global Connectivity](https://arxiv.org/abs/2605.05843)
...
### [5] [A Disaster-Aware Integrated TN-NTN System-Level Simulator for Resilient 6G Wireless Networks](https://arxiv.org/abs/2605.05852)
*Donglin Wang,Anjie Qiu,Qiuheng Zhou,Hans D. Schotten*
...
### [6] [FluxShard: Motion-Aware Feature Cache Reuse for Collaborative Video Analytics in Mobile Edge Computing](https://arxiv.org/abs/2605.06027)
...
### [7] [Temporal Spectral Noise-Floor Adaptation for Error-Intolerant Trigger Integrity in IoT Mesh Networks](https://arxiv.org/abs/2605.06338)
...
### [8] [Edge Triggering in IoT Mesh Networks: A Comparative Monte Carlo Study of Seven Detection Algorithms](https://arxiv.org/abs/2605.06358)
*Sergii Makovetskyi,Lars Thomsen*
...
### [15] [Indoor 60 GHz Radio Channel Dataset Enabling Digital Twin Construction](https://arxiv.org/abs/2605.05824)
...
### [16] [TGPP: Trajectory-Guided Plug-and-Play Priors for Sparse Radio Map Reconstruction](https://arxiv.org/abs/2605.05844)
...
### [25] [On Unbiased Parameter Estimation and Signal Reconstruction](https://arxiv.org/abs/2605.05276)
*Joonas Lahtinen*
...
### [26] [When Semantic Communication Meets Queueing: Cross-Layer Latency and Task Fidelity Optimization](https://arxiv.org/abs/2605.05514)
...
### [27] [Infinite families of constacyclic codes supporting 3-designs and their applications in coding theory](https://arxiv.org/abs/2605.05613)
...
### [28] [An Additive Approximation Scheme for Generating Dyadic Codings for the Outputs of an LLM](https://arxiv.org/abs/2605.05837)
...
### [29] [Identification for Inverse Gaussian Channels](https://arxiv.org/abs/2605.06103)
...
### [30] [Locally Repairable Codes with Availability via Elliptic Function Fields](https://arxiv.org/abs/2605.06182)
...
### [31] [Fluid Antenna Systems Enabling 6G HRLLC With Port Switching Delay](https://arxiv.org/abs/2605.06275)
...
### [32] [Affine Subcode Ensemble Decoding for Degeneracy-Aware Quantum Error Correction](https://arxiv.org/abs/2605.06547)
...
### [33] [Generalized Skew Multivariate Goppa Codes](https://arxiv.org/abs/2605.06580)
