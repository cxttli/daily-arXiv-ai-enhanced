...
### [7] [Learned Digital Codes for Over-the-Air Computation in Federated Edge Learning](https://arxiv.org/abs/2512.19777)
...
### [8] [Generative Bayesian Spectrum Cartography: Unified Reconstruction and Active Sensing via Diffusion Models](https://arxiv.org/abs/2512.20108)
...
### [9] [RIS-Empowered OTFS Modulation With Faster-than-Nyquist Signaling in High-Mobility Wireless Communications](https://arxiv.org/abs/2512.20332)
...
### [10] [Viterbi State Selection for Discrete Pinching Antenna Systems](https://arxiv.org/abs/2512.20389)
...
### [11] [Information-theoretic signatures of causality in Bayesian networks and hypergraphs](https://arxiv.org/abs/2512.20552)
...
### [12] [Enhanced Information Security via Wave-Field Selectivity and Structured Wavefront Manipulation](https://arxiv.org/abs/2512.19702)
...
### [13] [Securing the Sensing Functionality in ISAC: KLD-Based Ambiguity Function Shaping](https://arxiv.org/abs/2512.19974)
...
### [14] [From Optimization to Learning: Dual-Approach Resource Allocation for Over-the-Air Edge Computing Under Execution Uncertainty](https://arxiv.org/abs/2512.20008)
...
### [15] [PFA-NS: Power-Fading-Aware Noise Shaping Enabled C-Band IMDD System with Low Resolution DAC](https://arxiv.org/abs/2512.20010)
...
### [16] [Reliable LLM-Based Edge-Cloud-Expert Cascades for Telecom Knowledge Systems](https://arxiv.org/abs/2512.20012)
...
### [17] [EDA-RoF: Elastic Digital-Analog Radio-Over-Fiber (RoF) Modulation and Demodulation Architecture Enabling Seamless Transition Between Analog RoF and Digital RoF](https://arxiv.org/abs/2512.20018)
...
### [18] [A Covariance-Surrogate Framework for Movable-Antenna Enabled Anti-Jamming with Unknown Jammers](https://arxiv.org/abs/2512.20380)
...
### [19] [Robust and Secure Transmission for Movable-RIS Assisted ISAC with Imperfect Sense Estimation](https://arxiv.org/abs/2512.20071)
...
### [20] [Over-the-Air Goal-Oriented Communications](https://arxiv.org/abs/2512.20533)
...
### [21] [Target Classification for Integrated Sensing and Communication in Industrial Deployments](https://arxiv.org/abs/2512.20154)
...
### [22] [Sum-Rate Maximization for Uplink Segmented Waveguide-Enabled Pinching-Antenna Systems](https://arxiv.org/abs/2512.20246)
...
### [23] [A Tutorial to Multirate Extended Kalman Filter Design for Monitoring of Agricultural Anaerobic Digestion Plants](https://arxiv.org/abs/2512.20354)
