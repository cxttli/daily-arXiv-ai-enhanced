...
### [3] [Channel Selected Stratified Nested Cross Validation for Clinically Relevant EEG Based Parkinsons Disease Detection](https://arxiv.org/abs/2601.05276)
...
### [4] [SPARK: Sparse Parametric Antenna Representation using Kernels](https://arxiv.org/abs/2601.05440)
...
### [5] [Deformation-Aware Observation Modeling for Radar-Based Human Sensing via 3D Scan-Depth Sequence Fusion](https://arxiv.org/abs/2601.05676)
...
### [6] [A Novel Deep Learning-Based Coarse-to-Fine Frame Synchronization Method for OTFS Systems](https://arxiv.org/abs/2601.05920)
...
### [7] [Cedalion Tutorial: A Python-based framework for comprehensive analysis of multimodal fNIRS & DOT from the lab to the everyday world](https://arxiv.org/abs/2601.05923)
...
### [8] [Curving Beam Reflections: Model and Experimental Validation](https://arxiv.org/abs/2601.05998)
...
### [9] [Cooperative Differential GNSS Positioning: Estimators and Bounds](https://arxiv.org/abs/2601.06012)
...
### [10] [On the Limits of Self-Improving in LLMs and Why AGI, ASI and the Singularity Are Not Near Without Symbolic Model Synthesis](https://arxiv.org/abs/2601.05280)
*Hector Zenil*
...
### [11] [Multi-User Covert Communications via Intelligent Spectrum Control](https://arxiv.org/abs/2601.05281)
...
### [12] [Secure Communication via Modulation Order Confusion](https://arxiv.org/abs/2601.05292)
...
### [13] [The Number of Cycles of Bi-regular Tanner Graphs in Terms of the Eigenvalues of the Adjacency Matrix](https://arxiv.org/abs/2601.05340)
...
### [14] [Strong Singleton-Like Bounds, Quasi-Perfect Codes and Distance-Optimal Codes in the Sum-Rank Metric](https://arxiv.org/abs/2601.05581)
...
### [16] [Coset Shaping for Coded Modulation](https://arxiv.org/abs/2601.05652)
...
### [17] [Age of Gossip With Cellular Drone Mobility](https://arxiv.org/abs/2601.05983)
...
### [18] [Nonlinearity Mitigation for Coherent Ground-to-Satellite Optical Links](https://arxiv.org/abs/2601.05655)
...
### [19] [On the Complexity of Electromagnetic Far-Field Modeling](https://arxiv.org/abs/2601.05674)
...
### [20] [Secure Multiuser Beamforming With Movable Antenna Arrays](https://arxiv.org/abs/2601.05686)
...
### [21] [Universal and Asymptotically Optimal Data and Task Allocation in Distributed Computing](https://arxiv.org/abs/2601.05873)
