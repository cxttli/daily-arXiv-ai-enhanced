...
### [12] [RUL-QMoE: Multiple Non-crossing Quantile Mixture-of-Experts for Probabilistic Remaining Useful Life Predictions of Varying Battery Materials](https://arxiv.org/abs/2512.23725)
...
### [13] [Beamforming for Massive MIMO Aerial Communications: A Robust and Scalable DRL Approach](https://arxiv.org/abs/2512.23902)
...
### [14] [A multimodal Transformer for InSAR-based ground deformation forecasting with cross-site generalization across Europe](https://arxiv.org/abs/2512.23906)
...
### [15] [Movable Antenna Enhanced Multi-Region Beam Coverage: A Multi-Notch-Filter-Inspired Design](https://arxiv.org/abs/2512.24090)
...
### [16] [Discovering Optimal Robust Minimum Redundancy Arrays (RMRAs) through Exhaustive Search and Algebraic Formulation of a New Sub-Optimal RMRA](https://arxiv.org/abs/2512.24155)
...
### [17] [Quantifying the advantage of vector over scalar magnetic sensor networks for undersea surveillance](https://arxiv.org/abs/2512.24250)
...
### [18] [The Wigner-Ville Transform as an Information Theoretic Tool in Radio-frequency Signal Analysis](https://arxiv.org/abs/2512.24488)
...
### [19] [OptiVote: Non-Coherent FSO Over-the-Air Majority Vote for Communication-Efficient Distributed Federated Learning in Space Data Centers](https://arxiv.org/abs/2512.24334)
...
### [20] [A Uniform Pilot and Data Payload Optimization Framework for OTFS-Based ISAC](https://arxiv.org/abs/2512.24624)
...
### [21] [Low-complexity spectral shaping method for OFDM signals with dynamically adaptive emission mask](https://arxiv.org/abs/2512.24412)
...
### [22] [Power Minimization in Pinching-Antenna Systems under Probabilistic LoS Blockage](https://arxiv.org/abs/2512.24573)
...
### [23] [Resource Allocation via Backscatter-Aware Transmit Antenna Selection for Low-PAPR and Ultra-Reliable WSNs](https://arxiv.org/abs/2512.24583)
...
### [24] [Beam-Squint-Aided Hierarchical Sensing for Integrated Sensing and Communications with Uniform Planar Arrays](https://arxiv.org/abs/2512.24727)
...
### [25] [Digitalizing Over-the-Air Computation via The Novel Complement Coded Modulation](https://arxiv.org/abs/2512.24788)
...
### [26] [Efficient Joint Resource Allocation for Wireless Powered ISAC with Target Localization](https://arxiv.org/abs/2512.24815)
...
### [27] [No Vision, No Wearables: 5G-based 2D Human Pose Recognition with Integrated Sensing and Communications](https://arxiv.org/abs/2512.24923)
...
### [28] [Fundamental Limits for Near-Field Sensing -- Part I: Narrow-Band Systems](https://arxiv.org/abs/2512.24958)
...
### [29] [Fundamental Limits for Near-Field Sensing -- Part II: Wide-Band Systems](https://arxiv.org/abs/2512.24962)
*Tong Wei,Kumar Vijay Mishra,Bhavani Shankar M. R.,Björn Ottersten*
...
### [30] [Hierarchical Quasi-cyclic Codes from Reed-Solomon and Polynomial Evaluation Codes](https://arxiv.org/abs/2512.23872)
...
### [31] [Continuous Angular Power Spectrum Recovery From Channel Covariance via Chebyshev Polynomials](https://arxiv.org/abs/2512.24039)
...
### [32] [Random Multiplexing](https://arxiv.org/abs/2512.24087)
...
### [33] [When Wires Can't Keep Up: Reconfigurable AI Data Centers Empowered by Terahertz Wireless Communications](https://arxiv.org/abs/2512.24110)
...
### [34] [Efficient Decoding of Twisted GRS Codes and Roth--Lempel Codes](https://arxiv.org/abs/2512.24217)
...
### [35] [SC-LDPC Codes Over $\mathbb{F}_q$: Minimum Distance, Decoding Analysis and Threshold Saturation](https://arxiv.org/abs/2512.24232)
...
### [36] [Infinite families of graphs and stable completion of arbitrary matrices, Part I](https://arxiv.org/abs/2512.24468)
*Augustin Cosse*
...
### [37] [Throughput Optimization in UAV-Mounted RIS under Jittering and Imperfect CSI via DRL](https://arxiv.org/abs/2512.24773)
...
### [38] [Overflow-Avoiding Memory AMP](https://arxiv.org/abs/2407.03898)
...
### [39] [Random Modulation: Achieving Asymptotic Replica Optimality over Arbitrary Norm-Bounded and Spectrally Convergent Channel Matrices](https://arxiv.org/abs/2508.08099)
