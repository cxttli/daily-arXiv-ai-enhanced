...
### [7] [NeuroNarrator: A Generalist EEG-to-Text Foundation Model for Clinical Interpretation via Spectro-Spatial Grounding and Temporal State-Space Reasoning](https://arxiv.org/abs/2603.16880)
...
### [8] [DECODE: Dual-Enhanced Conditioned Diffusion for EEG Forecasting](https://arxiv.org/abs/2603.16885)
...
### [9] [A Novel end-to-end Digital Health System Using Deep Learning-based ECG Analysis](https://arxiv.org/abs/2603.16891)
...
### [10] [EEG-SeeGraph: Interpreting functional connectivity disruptions in dementias via sparse-explanatory dynamic EEG-graph learning](https://arxiv.org/abs/2603.16895)
...
### [11] [EEG-Based Brain-LLM Interface for Human Preference Aligned Generation](https://arxiv.org/abs/2603.16897)
...
### [12] [CRB-Based Resource Allocation in Multi-User Uplink Transmissions](https://arxiv.org/abs/2603.17082)
...
### [13] [Physical Layer Security for FAS-Aided Short-Packet Systems: A Variable Block-Correlation Approach](https://arxiv.org/abs/2603.17224)
...
### [14] [WiSLAT: A Simultaneous Device Localization and Target Tracking Method for Wi-Fi Systems](https://arxiv.org/abs/2603.17283)
...
### [15] [Near-Field NLOS Localization via Position-Unknown HRIS:From Self-Localization to Target Positioning](https://arxiv.org/abs/2603.17297)
...
### [16] [A Joint Graph-Cut Channel Estimation Method for Multi-user Holographic MIMO](https://arxiv.org/abs/2603.17369)
...
### [17] [Fully 3D-Printed Wideband Metasurface Folded Reflectarray Antenna](https://arxiv.org/abs/2603.17526)
...
### [18] [Hybrid Beamforming via Programmable Unitary RF Networks](https://arxiv.org/abs/2603.17616)
...
### [19] [3D Spherical Directly-Connected Antenna Array for Low-Altitude UAV Swarm ISAC](https://arxiv.org/abs/2603.17620)
...
### [20] [Fast Beam-Brainstorm: Few-Step Generative Site-Specific Beamforming with Flexible Probing](https://arxiv.org/abs/2603.17622)
...
### [21] [Optimizing Antenna Coding for Pixel Antenna Empowered SISO-OFDM Systems](https://arxiv.org/abs/2603.17658)
...
### [22] [Design of Uplink ISAC Systems with Cooperative Sensing: Power Control and Receive Beamforming](https://arxiv.org/abs/2603.17744)
...
### [23] [Fairness-Aware Beamforming for Polarimetric ISAC Systems with Polarization-Reconfigurable Antennas](https://arxiv.org/abs/2603.17762)
...
### [24] [Vehicle-to-Vehicle Millimeter-Wave Channel Characterization at 60 and 80 GHz](https://arxiv.org/abs/2603.17766)
...
### [25] [Comparison of 60 GHz and 80 GHz Vehicle-to-Vehicle Channels Using Delay and Doppler Characteristics](https://arxiv.org/abs/2603.17817)
...
### [26] [Modulation Symbol Pulse Shaping Transceiver for Affine Frequency Division Multiplexing](https://arxiv.org/abs/2603.17935)
...
### [27] [Coded Information Retrieval for Block-Structured DNA-Based Data Storage](https://arxiv.org/abs/2603.17154)
*Daniella Bar-Lev*
...
### [28] [Asymptotically ideal Disjunctive Hierarchical Secret Sharing Scheme with an Explicit Construction](https://arxiv.org/abs/2603.17257)
...
### [29] [Shannon meets Gödel-Tarski-Löb: Undecidability of Shannon Feedback Capacity for Finite-State Channels](https://arxiv.org/abs/2603.17317)
*Angshul Majumdar*
...
### [30] [Physical Layer Security in Finite Blocklength Massive IoT with Randomly Located Eavesdroppers](https://arxiv.org/abs/2603.17665)
