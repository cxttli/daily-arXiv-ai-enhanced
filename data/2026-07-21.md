...
### [19] [Task-Oriented Precoding for Edge Inference over Large-Scale MIMO Systems](https://arxiv.org/abs/2607.17877)
...
### [20] [Optimal Domain-Aware Privacy Mechanisms for Synthetic Data Generation](https://arxiv.org/abs/2607.18021)
...
### [21] [When Phase Doesn't Matter: Self-Coherent Over-the-Air Computation at Sub-THz](https://arxiv.org/abs/2607.18052)
...
### [22] [Compositional Semantic Communication for Physical AI: Category Theory Meets Game Theory](https://arxiv.org/abs/2607.18115)
...
### [23] [Overcoming the BCI Calibration Bottleneck: A Clinically-Grounded Architecture using Riemannian Alignment and Stochastic Weight Averaging](https://arxiv.org/abs/2607.16225)
...
### [24] [From Intent to Infrastructure: LLM-Driven Agent Compilers for ISAC Networks](https://arxiv.org/abs/2607.16269)
...
### [25] [Physics-Informed Feature Engineering 1D-CNN for Multilayer Cloud Detection from Geostationary Satellites](https://arxiv.org/abs/2607.16270)
...
### [26] [Efficient EEG Seizure Detection Using INT8 Quantization, Channel Pruning, and Spiking Neural Networks](https://arxiv.org/abs/2607.16296)
*Kartikey Ahlawat*
...
### [27] [Robust and Feasible QoS-Aware mmWave Massive MIMO Hybrid Beamforming](https://arxiv.org/abs/2607.16306)
...
### [28] [ECG-LLM: Foundation Model for ECG-Based Cardiac Reasoning](https://arxiv.org/abs/2607.16323)
...
### [29] [Joint-Embedding Predictive Architecture for Sensor-based Activity Recognition](https://arxiv.org/abs/2607.16350)
...
### [30] [Scalable Attention for 5G NR Channel Estimation](https://arxiv.org/abs/2607.16462)
...
### [31] [Polynomial Chaos Expansion Based Nonlinear Filtering of Stochastic Processes](https://arxiv.org/abs/2607.16504)
...
### [32] [RIS-Aided ISAC in Cluttered Environments](https://arxiv.org/abs/2607.16611)
...
### [33] [Toward a Stable and Deployable Adaptive Chirplet Transform: Residual Projection, Hybrid GPU Acceleration, and Multi-Channel Scalability](https://arxiv.org/abs/2607.16629)
...
### [34] [EEGPrep: a validated Python implementation of the EEGLAB preprocessing pipeline](https://arxiv.org/abs/2607.16647)
...
### [35] [Joint Optimization of Uplink and Downlink Resources under QoS Constraints of AR](https://arxiv.org/abs/2607.16722)
...
### [36] [Task-Oriented Communication with Hybrid-Precision Models](https://arxiv.org/abs/2607.16766)
...
### [37] [Demodulation of chaotic signals using convolutional neural network](https://arxiv.org/abs/2607.16788)
...
### [38] [Power-Domain-Multiplexed Precoded Faster-Than-Nyquist Signaling for NOMA Downlink](https://arxiv.org/abs/2607.16853)
...
### [39] [Hierarchical Wireless Foundation Model for Multi-Task Optimization](https://arxiv.org/abs/2607.16877)
...
### [40] [Outage Analysis of Backscatter-Based Ambient IoT Device Classes with Energy Buffering](https://arxiv.org/abs/2607.16919)
...
### [41] [Intelligent Code-Division Multiplexing for Resilient Underwater Optical Wireless Communications](https://arxiv.org/abs/2607.16925)
...
### [42] [Efficient Audio-Visual Event Recognition via Knowledge Distillation and Dynamic INT8 Quantization of a Hybrid Cross-Attention Network](https://arxiv.org/abs/2607.16980)
...
### [43] [Off-grid Variational Bayesian Parameter Estimation for Fractional Delay-Doppler OTFS-ISAC](https://arxiv.org/abs/2607.17001)
...
### [44] [Movable Antenna for Integrated Sensing and Communication in Air Sea Ground Networks](https://arxiv.org/abs/2607.17041)
...
### [45] [Radio Map Updating from Streaming Spectrum Measurements via Memory-Based Online Gaussian Processes](https://arxiv.org/abs/2607.17954)
...
### [46] [Fourth-Order Cyclostationary Analysis of Power-Based Nonlinear Gardner Timing Error Detectors in Coherent Optical Systems](https://arxiv.org/abs/2607.17135)
...
### [47] [Inverse-Reinforcement Learning Enabled Digital Twin for Intent-based Drone Networks](https://arxiv.org/abs/2607.17186)
...
### [48] [Broadband Content-Adaptive Moiré Meta-spectrometer](https://arxiv.org/abs/2607.17256)
...
### [49] [An Enhanced MNOMP for Line Spectrum Estimation and Detection](https://arxiv.org/abs/2607.17308)
...
### [50] [Transmissive RIS Transceiver-Empowered ISAC Systems: Energy Efficiency Optimization for Perfect and Imperfect CSI](https://arxiv.org/abs/2607.17475)
...
### [51] [Transmit Beamforming Design for Integrated Sensing and Communication Using Transmissive RIS Transceiver](https://arxiv.org/abs/2607.17485)
...
### [52] [Constrained Tensor Decomposition-Based Target Sensing for Sparse Non-Uniform Array-Enabled AFDM ISAC Systems](https://arxiv.org/abs/2607.17589)
...
### [53] [Tensor-Based Dynamic Channel Estimation for mmWave Movable Antenna MIMO Systems](https://arxiv.org/abs/2607.17591)
...
### [54] [Waveform Design for OTFS Assisted Simultaneous Acoustic Information and Power Transfer](https://arxiv.org/abs/2607.17631)
...
### [55] [DMSNet: Cross-Band Learning for Multi-Target Sensing in Multi-Band ISAC](https://arxiv.org/abs/2607.17655)
...
### [56] [Ambiguity Function Analysis of Pilot-Embedded Random OFDM Signals](https://arxiv.org/abs/2607.17663)
...
### [57] [On the Detection Optimality and Exact BER Analysis of NOMA](https://arxiv.org/abs/2607.17755)
...
### [58] [Deep Recurrent Q-Learning Based Beam Steering Strategy for Throughput Maximization in WPCNs](https://arxiv.org/abs/2607.17838)
...
### [59] [Massive MIMO-OFDM ISAC for Sparse ISAR Imaging: Joint Power and Subcarrier Allocation](https://arxiv.org/abs/2607.17862)
...
### [60] [System-Level Evaluation of LEO Satellite Communications Under Service-Driven Traffic Dynamics](https://arxiv.org/abs/2607.17993)
...
### [61] [Self-Interference-Aware AS-Assisted Tri-Hybrid Beamforming for Full-Duplex Massive MIMO](https://arxiv.org/abs/2607.18036)
...
### [62] [Reproducible Research in Network Modeling](https://arxiv.org/abs/2607.16433)
...
### [63] [Robust KV Cache Management for LLM Serving under Output Token Length Uncertainty](https://arxiv.org/abs/2607.16892)
...
### [64] [PERA: A Perceive-Reason-Act Interface Bridging Sensing, Cognitive Reasoning, and Trustworthy Agentic Response for 6G](https://arxiv.org/abs/2607.16896)
...
### [65] [A Multi-Agent System for 5G Throughput Prediction in Multi-Operator Urban Environments](https://arxiv.org/abs/2607.16930)
...
### [66] [OrderMoE: An expert similarity driven distributed edge MoE inference](https://arxiv.org/abs/2607.17154)
...
### [67] [DAN-Scheduler: Deterministic Three-Stage Co-Optimization of Scheduling, Memory Layout, and Pipeline Overlap for General-Purpose NPUs](https://arxiv.org/abs/2607.17422)
...
### [68] [Diverge-Merge Formation and MAC Control in Structured Airspace](https://arxiv.org/abs/2607.17489)
...
### [69] [Self-Directed Spectrum Allocation Framework for Integrated TN-NTN 6G Networks](https://arxiv.org/abs/2607.17561)
...
### [70] [Token Communications (TokCom): A Unified AI-Native Communication Framework](https://arxiv.org/abs/2607.17628)
...
### [71] [Mobile Network Control with a World Model](https://arxiv.org/abs/2607.17747)
...
### [72] [Beyond Car Sharing: Uncertainty-Aware Pooling of Vehicular Compute at the Network Edge](https://arxiv.org/abs/2607.17893)
...
### [73] [Enhanced Dynamic Beamwidth Selection-based THz MAC Protocol for Wireless Data Center Networks](https://arxiv.org/abs/2607.17996)
...
### [74] [Human Grounded Evaluation of Large Language Models for Optical Network Automation](https://arxiv.org/abs/2607.18068)
...
### [75] [ClouDens: Operational Context-Aware Anomaly Detection for Large-scale Cloud System Monitoring](https://arxiv.org/abs/2607.18127)
...
### [76] [AI Agent Communications in AI-Native 6G Network: Status, Challenges and Opportunities](https://arxiv.org/abs/2607.18138)
*Qiang Duan*
