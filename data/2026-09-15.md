...
### [2] [Proportional-Fair Resource Allocation and Dual-Threshold Early-Exit Inference for Secure Cooperative Multi-Layer Edge Intelligence](https://arxiv.org/abs/2609.15847)
...
### [3] [When Do Pilots Matter for OFDM Sensing? Pilot-Data Resource Design for ISAC](https://arxiv.org/abs/2609.13329)
...
### [4] [A New Upper Bound on the Binary Deletion Channel Capacity](https://arxiv.org/abs/2609.13351)
*Özgür Soysal*
...
### [5] [From Priors to Projections: Geometry and simplified MIMO demodulation of probabilistic shaping](https://arxiv.org/abs/2609.13492)
...
### [6] [Beam Squint and Aperture--Bandwidth Limitations in Wideband RIS-Assisted THz Links](https://arxiv.org/abs/2609.14037)
...
### [7] [Universal Estimation of the Fisher Information for Processes with Memory](https://arxiv.org/abs/2609.14582)
...
### [8] [Task-Aware Beamforming for Semantic Wireless Localization](https://arxiv.org/abs/2609.14801)
...
### [9] [Private Information Retrieval With Arbitrary Privacy Requirements: Introduction and Capacity Results](https://arxiv.org/abs/2609.15875)
...
### [10] [Noise-Domain OTFS: Statistical Delay-Doppler Signaling for Future Wireless Networks](https://arxiv.org/abs/2609.13557)
*Mahmoud Aldababsa*
...
### [11] [Combating Suppressive Jamming with Dynamic Agile Reconfigurable Intelligent Surface Antenna Array (DARISAA)](https://arxiv.org/abs/2609.14511)
...
### [12] [HELENA for 5G NR LEO NTN Channel Estimation: A Comparative Evaluation](https://arxiv.org/abs/2609.14735)
...
### [13] [Full-Wave-Calibrated Element-Wise RIS Modeling With Cross-Aperture Coefficient Transfer for Multipath Channel Prediction](https://arxiv.org/abs/2609.15173)
...
### [14] [A Joint Information-Theoretic and Graph Learning Framework for Sensor Placement and Macroscopic Traffic State Reconstruction](https://arxiv.org/abs/2609.13212)
...
### [15] [Multiscale Gaussian-Mixture Modeling for HMM Post-Processing in Selective Auditory Attention Decoding](https://arxiv.org/abs/2609.15490)
...
### [16] [Contact-Limited Throughput of a Buoyless Acoustic-to-LEO Gateway With Anticipatory Preparation](https://arxiv.org/abs/2609.15508)
*Muhammad Khalil*
...
### [17] [AI-based Interference Mitigation for Power-domain Spectrum Sharing among LEO Satellites](https://arxiv.org/abs/2609.15594)
...
### [18] [Packet-Level Complex CIR Tracking for Communication-Native mmWave Sensing: An 802.11ad Testbed](https://arxiv.org/abs/2609.15622)
...
### [19] [CoFi-CLM: A Coarse-to-Fine Channel Language Model for Finite-Bit CSI Feedback](https://arxiv.org/abs/2609.15865)
