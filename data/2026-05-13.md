...
### [1] [Agents Should Replace Narrow Predictive AI as the Orchestrator in 6G AI-RAN](https://arxiv.org/abs/2605.11516)
...
### [2] [Avoiding Cross-Datacenter Collective Congestion via Disaggregated Buffering](https://arxiv.org/abs/2605.11852)
...
### [3] [Energy Consumption in Next Generation Radio Access Networks](https://arxiv.org/abs/2605.11899)
...
### [4] [Improving D-Optimal Sensor Placement for Bearing-Only Localization via Maximum-Entropy Reweighting](https://arxiv.org/abs/2605.11116)
*Raktim Bhattacharya*
...
### [5] [Design of a validation methodology for a prototype wristband for capturing muscle signals and upper limb movement](https://arxiv.org/abs/2605.11148)
...
### [6] [Enabling AI-Native Mobility in 6G: A Real-World Dataset for Handover, Beam Management, and Timing Advance](https://arxiv.org/abs/2605.12453)
...
### [7] [Fluid Antenna-Enabled Hybrid NOMA and AirFL Networks Under Imperfect CSI and SIC](https://arxiv.org/abs/2605.11273)
...
### [8] [Adaptive Diagonal Loading using Krylov Subspaces for Robust Beamforming](https://arxiv.org/abs/2605.11286)
...
### [9] [XFreq-GS: Cross-Frequency Wireless Radiation Field Reconstruction with 3D Gaussian Splatting](https://arxiv.org/abs/2605.11432)
...
### [10] [Unification of Signal Transform Theory](https://arxiv.org/abs/2605.11589)
*Mitchell A. Thornton*
...
### [11] [Stepped Frequency Division Multiplexing: A Jump-Free Continuous-Time AFDM Waveform](https://arxiv.org/abs/2605.11657)
...
### [12] [Assessment of Time-of-Arrival Estimation Methods for Impact Detection in Isotropic Plates using Piezoceramic Sensors](https://arxiv.org/abs/2605.11763)
...
### [13] [Long-Range Backscatter: A Bottom-Up Approach](https://arxiv.org/abs/2605.11811)
...
### [14] [PointNeRT: A Physics Aware Neural Ray Tracing Surrogate for Propagation Channel Modeling](https://arxiv.org/abs/2605.11828)
...
### [15] [Modulation Consistency-based Contrastive Learning for Self-Supervised Automatic Modulation Classification](https://arxiv.org/abs/2605.11875)
...
### [16] [ISAC for AI: A Trade-off Framework Across Data Acquisition and Transfer in Federated Learning](https://arxiv.org/abs/2605.11915)
...
### [17] [Spatial Power Estimation via Riemannian Covariance Matching](https://arxiv.org/abs/2605.11917)
...
### [18] [Low-Complexity Blind SNR Estimator for mmWave Multi-Antenna Communications](https://arxiv.org/abs/2605.12086)
...
### [19] [Slow Movable Antenna System Design Based on Cell-Specific Long-Term Angular Power Spectrum](https://arxiv.org/abs/2605.12192)
...
### [20] [BFLA: Block-Filtered Long-Context Attention Mechanism](https://arxiv.org/abs/2605.12193)
...
### [21] [Pretraining Strategies and Scaling for ECG Foundation Models: A Systematic Study](https://arxiv.org/abs/2605.12241)
...
### [22] [From EEG Cleaning to Decoding: The Role of Artifact Rejection in MI-based BCIs](https://arxiv.org/abs/2605.12408)
...
### [23] [Massive MIMO CSI Feedback with Spiking Neural Networks](https://arxiv.org/abs/2605.12434)
...
### [24] [On Capacity and Delay of Wireless Networks with Node Failures](https://arxiv.org/abs/2605.12080)
...
### [25] [Annotation-Free Indoor Radio Mapping via Physics-Informed Trajectory Inference](https://arxiv.org/abs/2605.11037)
...
### [27] [Survey-Free Radio Map Construction via HMM-Based Coarse-to-Fine Inference](https://arxiv.org/abs/2605.11038)
...
### [28] [Sensor Design for Accuracy-Bounded Estimation via Maximum-Entropy Likelihood Synthesis](https://arxiv.org/abs/2605.11120)
*Raktim Bhattacharya*
...
### [29] [Simultaneously Minimizing Storage and Bandwidth Under Exact Repair With Quantum Entanglement](https://arxiv.org/abs/2605.12455)
...
### [30] [Parameter Estimation of Mutual Information Maximized Channels](https://arxiv.org/abs/2605.11352)
...
### [31] [RankGuardPolar Private Public Finite Length Polar Codes with Rank-Certified Leakage](https://arxiv.org/abs/2605.11356)
*Hassan Tavakoli,Thinh Nguyen,Bella Bose*
...
### [32] [Optimal Codes with Positive Griesmer Defects, Related Optimal and Almost Optimal LRC Codes](https://arxiv.org/abs/2605.11431)
...
### [33] [Recent Advances in Spatially Coupled Codes: Overview and Outlook](https://arxiv.org/abs/2605.11542)
...
### [34] [The Entropy of Floating-Point Numbers](https://arxiv.org/abs/2605.11546)
...
### [35] [Performance of QUBO-Formulated MIMO Detection Under Hardware Precision Constraints](https://arxiv.org/abs/2605.11626)
...
### [36] [Schur Products of Constacyclic Codes via the Constacyclic Discrete Fourier Transform](https://arxiv.org/abs/2605.11650)
*Peifeng Lin*
...
### [37] [Empirical coordination in the finite blocklength regime: an achievability result---Extended version](https://arxiv.org/abs/2605.11810)
...
### [38] [Maximum Entropy of Sums of Independent Ternary Random Variables](https://arxiv.org/abs/2605.11831)
*Mladen Kovačević*
...
### [39] [Constacyclic codes of length $np^s$ over $\frac{\mathbb{F}_{p^m}[u]}{\langle u^t\rangle}$: Torsions and Cardinalities](https://arxiv.org/abs/2605.11912)
...
### [40] [From Submodularity to Matrix Determinants: Strengthening Han's, Szász's, and Fischer's Inequalities](https://arxiv.org/abs/2605.11998)
...
### [41] [CR^2: Cost-Aware Risk-Controlled Routing for Wireless Device-Edge LLM Inference](https://arxiv.org/abs/2605.12001)
...
### [43] [A framework for constructing non-GRS MDS-NMDS codes from deep holes and its application](https://arxiv.org/abs/2605.12133)
...
### [44] [A Deep Learning-based Receiver for Asynchronous Grant-Free Random Access in Control-to-Control Networks](https://arxiv.org/abs/2605.12180)
...
### [45] [Secure (Multiple) Key-Cast over Networks: Multiple Eavesdropping Nodes](https://arxiv.org/abs/2605.12209)
...
### [46] [Angle Between Two Vectors over Finite Fields and an Application to Projective Unique Decoding](https://arxiv.org/abs/2605.12216)
*Kamil Otal*
...
### [47] [An Improved Lower Bound on Support Size of Capacity-Achieving Inputs for the Binomial Channel: Extended version](https://arxiv.org/abs/2605.12472)
