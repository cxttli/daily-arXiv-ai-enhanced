...
### [2] [An Enhanced Polar-Domain Dictionary Design for Elevated BSs in Near-Field U-MIMO](https://arxiv.org/abs/2602.04331)
...
### [3] [The Turing Synthetic Radar Dataset: A dataset for pulse deinterleaving](https://arxiv.org/abs/2602.03856)
...
### [4] [Cross-Attention Transformer for Joint Multi-Receiver Uplink Neural Decoding](https://arxiv.org/abs/2602.04728)
...
### [5] [PENGUIN: General Vital Sign Reconstruction from PPG with Flow Matching State Space Model](https://arxiv.org/abs/2602.03858)
...
### [6] [Polynomial Closed-Form Model for Evaluating Nonlinear Interference in Any Island](https://arxiv.org/abs/2602.03860)
...
### [7] [A Multi-Modal Foundational Model for Wireless Communication and Sensing](https://arxiv.org/abs/2602.04016)
...
### [8] [Cross-Frequency Bispectral EEG Analysis of Reach-to-Grasp Planning and Execution](https://arxiv.org/abs/2602.04018)
...
### [9] [Ultra-Fast Device-Free Visible Light Sensing and Localization via Reflection-Based ΔRSS and Deep Learning](https://arxiv.org/abs/2602.04062)
...
### [10] [Structure-Informed Estimation for Pilot-Limited MIMO Channels via Tensor Decomposition](https://arxiv.org/abs/2602.04083)
...
### [11] [Uncertainty Principle for Vertex-Time Graph Signal Processing](https://arxiv.org/abs/2602.04084)
...
### [12] [Semantic Pilot Design for Data-Aided Channel Estimation Using a Large Language Model](https://arxiv.org/abs/2602.04126)
...
### [13] [Spatial Angular Pseudo-Derivative Searching: A Single Snapshot Super-resolution Sparse DOA Scheme with Potential for Practical Application](https://arxiv.org/abs/2602.04169)
...
### [14] [GPINND: A deep-learning-based state of health estimation for Lithium-ion battery](https://arxiv.org/abs/2602.04187)
...
### [15] [Maneuverable-Jamming-Aided Secure Communication and Sensing in A2G-ISAC Systems](https://arxiv.org/abs/2602.04209)
...
### [16] [Aortic Valve Disease Detection from PPG via Physiology-Informed Self-Supervised Learning](https://arxiv.org/abs/2602.04266)
...
### [17] [Joint Fractional Delay and Doppler Frequency Estimator Under Spectrum Wrapping Phenomenon for LEO-ICAN AFDM Signals](https://arxiv.org/abs/2602.04316)
...
### [18] [Rigid Body Localization via Gaussian Belief Propagation with Quadratic Angle Approximation](https://arxiv.org/abs/2602.04410)
...
### [19] [An Information-Theoretic Detector for Multiple Scatterers in SAR Tomography](https://arxiv.org/abs/2602.04465)
...
### [21] [Learning to Separate RF Signals Under Uncertainty: Detect-Then-Separate vs. Unified Joint Models](https://arxiv.org/abs/2602.04650)
...
### [22] [HFMCA: Orthonormal Feature Learning for EEG-based Brain Decoding](https://arxiv.org/abs/2602.04681)
...
### [23] [Knowledge Distillation for mmWave Beam Prediction Using Sub-6 GHz Channels](https://arxiv.org/abs/2602.04703)
...
### [24] [Resilient Channel Charting Under Varying Radio Link Availability](https://arxiv.org/abs/2602.04704)
...
### [26] [Semantic Rate Distortion and Posterior Design: Compute Constraints, Multimodality, and Strategic Inference](https://arxiv.org/abs/2602.03949)
*Emrah Akyol*
...
### [27] [Joint Sleep Mode Activation and Load Balancing with Dynamic Cell Load: A Combinatorial Bandit Approach](https://arxiv.org/abs/2602.04808)
...
### [28] [Game of Coding for Vector-Valued Computations](https://arxiv.org/abs/2602.04810)
...
### [29] [Capacity Bounds on Doppler OFDM Channels](https://arxiv.org/abs/2602.04862)
...
### [30] [Less is More: Optimizing Probe Selection Using Shared Latency Anomalies](https://arxiv.org/abs/2602.03965)
...
### [31] [Multi-Tier UAV Edge Computing Towards Long-Term Energy Stability for Low Altitude Networks](https://arxiv.org/abs/2602.04258)
...
### [32] [LLM-Empowered Cooperative Content Caching in Vehicular Fog Caching-Assisted Platoon Networks](https://arxiv.org/abs/2602.04471)
...
### [33] [Dual Mind World Model Inspired Network Digital Twin for Access Scheduling](https://arxiv.org/abs/2602.04566)
...
### [34] [On Dual Connectivity in 6G Leo Constellations](https://arxiv.org/abs/2602.04825)
