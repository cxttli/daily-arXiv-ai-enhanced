...
### [10] [Sample entropy for graph signals: An approach to nonlinear dynamic analysis of data on networks](https://arxiv.org/abs/2604.05086)
...
### [11] [Graph Signal Diffusion Models for Wireless Resource Allocation](https://arxiv.org/abs/2604.05175)
...
### [12] [Quasi-stationary Slice Detection-Based Robust Respiration Rate Estimation under Large-scale Random Body Movement](https://arxiv.org/abs/2604.05353)
...
### [13] [DDA-Net: Accurate TDD Channel Estimation via Deep Unfolding the Doppler-Delay-Angle Representation of Channel Signals](https://arxiv.org/abs/2604.05389)
...
### [14] [Operator-Theoretic Energy Functionals for Impulse-Excited Nonstationary Signal Analysis](https://arxiv.org/abs/2604.05413)
*Tahir Cetin Akinci*
...
### [15] [Waveguide to Meaning: Semantic-Aware NOMA for Pinching-Antenna Systems](https://arxiv.org/abs/2604.05464)
...
### [16] [Semantic Communication with an LLM-enabled Knowledge Base](https://arxiv.org/abs/2604.05504)
...
### [17] [Learned Elevation Models as a Lightweight Alternative to LiDAR for Radio Environment Map Estimation](https://arxiv.org/abs/2604.05520)
...
### [18] [Rotatable Antenna Enabled Multi-Cell Mixed Near-Field and Far-Field Communications](https://arxiv.org/abs/2604.05565)
...
### [19] [A BEV-Fusion Based Framework for Sequential Multi-Modal Beam Prediction in mmWave Systems](https://arxiv.org/abs/2604.05668)
...
### [20] [Configuration Tuning for ISAC: Cost-Efficient Adaptation via RACE-CMA](https://arxiv.org/abs/2604.05792)
...
### [21] [Ray-Based Simulation of Scattering from Discretized Curved Bodies for Vehicular and ISAC Applications](https://arxiv.org/abs/2604.05991)
...
### [22] [Opportunistic Network-Level ISAC with Cooperative Sensing: A Meta-Distribution Analysis](https://arxiv.org/abs/2604.06069)
...
### [23] [Edge Intelligence for Satellite-based Earth Observation: Scheduling Image Acquisition and Processing](https://arxiv.org/abs/2604.05937)
...
### [24] [Design and Analysis of Chirp-Layered Superposition Coding for LoRa](https://arxiv.org/abs/2604.06033)
